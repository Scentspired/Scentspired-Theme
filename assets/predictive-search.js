class PredictiveSearch extends SearchForm {
  ...
  getSearchResults(searchTerm) {
    ...
    fetch(
      ...
      .then(text => {
        ...
        const section = parsed ? parsed.querySelector("#shopify-section-predictive-search") : null;
  ...
  setLiveRegionLoadingState() {
    ...
    if (this.loadingText) this.setLiveRegionText(this.loadingText);
  ...
  renderSearchResults(resultsMarkup) {
    if (this.predictiveSearchResults) this.predictiveSearchResults.innerHTML = resultsMarkup;
