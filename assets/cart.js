...
class CartItems extends HTMLElement {
  ...
  updateQuantity(line, quantity, event, name, variantId) {
    ...
    const eventTarget =
      event && event.currentTarget instanceof CartRemoveButton ? "clear" : "change";
      ...
      .then(state => {
        ...
        CartPerformance.measure(`${eventTarget}:paint-updated-sections"`, () => {
          ...
          const cartDrawerWrapper =
            document.querySelector("cart-drawer") || document.querySelector("#sp-cart-drawer");
          ...
          const updatedValue =
            parsedState.items && parsedState.items[line - 1]
