...
const localUsaDir = path.resolve(ROOT, 'regions/usa');
const externalUsaDir = path.resolve(ROOT, '../Scentspired-USA');
const USA_DIR = fs.existsSync(localUsaDir) ? localUsaDir : externalUsaDir;
