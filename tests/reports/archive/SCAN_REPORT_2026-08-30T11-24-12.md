...
```liquid
    2318 |       // Disable + button if at max inventory using CSS class
    2319 |       if (cartItem && cartItem.quantity >= inventory && plusBtn) {
>>  2320 |         plusBtn.classList.add('sp-qty-disabled');
    2321 |         plusBtn.disabled = true;
    2322 |       } else if (plusBtn) {
```
